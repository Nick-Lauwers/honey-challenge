class WorkerBee < ApplicationRecord
  ...
  # We can map WorkerBees to Combs using a "has_many, through" relationship. 
  # WorkerBees can be mapped to Combs through PollenGlobs, Nectars, or 
  ...
  # duplicates of the "WorkerBee -> PollenGlob -> Comb" relationship.
