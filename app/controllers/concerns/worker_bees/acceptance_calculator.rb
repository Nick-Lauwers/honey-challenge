module WorkerBees
	module AcceptanceCalculator
		...
		def calculate_perc_accepted(worker_bee, comb)
			...
			# Set the number of accepted advisements, the number of total advisements, and the default advisement
			# amount to 0.
		...
		private
			...
			# Since PollenGlob production, Nectar consumption, and Advisements are contained in separate DB tables, we 
			# should combine them into a single data structure before presenting them on the WorkerBee page; We will 
